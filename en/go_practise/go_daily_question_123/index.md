...
`People` has a `Show` method and belongs to a non-empty interface.
...
Here, the `itab` of the interface already points to `Student`. Therefore, the interface is not nil.
...
> Author: loommii  
> URL: https://loommii.github.io/en/go_practise/go_daily_question_123/  
