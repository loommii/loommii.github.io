...
2. 未初始化写入
    ...
    - append
        ...
        不会发panic,可以正常写入 <https://go.dev/play/p/wo6M-xCZ6XW>
...
## 为什么未初始化Map写入会panic 而slice(切片)不会)
...
make map的时候 会设置hash0哨因子,若未初始化hash0就为0。操作的时候会除以hash0 ./0 是不被允许的
...
> 作者: loommii  
> URL: https://loommii.github.io/zh-cn/posts/what_happens_if_go_map_slice_is_not_initialized/  
